...
public class CustomListViewAdaptateur extends BaseAdapter implements ListAdapter {

    private ArrayList<ItemCourse> listeCourse = new ArrayList<>();
    private Context context;

    public CustomListViewAdaptateur(ArrayList<ItemCourse> list, Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        rl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                generateModifyItemDialog(listeCourse.get(position), finalView,position);
            }
        });
        return view;
    }

    private void generateModifyItemDialog(final ItemCourse itemCourse, final View view, final int position) {
        final AlertDialog.Builder builder = new AlertDialog.Builder(this.context);
        builder.setTitle("Que faites vous de cet item : " + itemCourse.getDenomination());
